...
public class Prac02 {
	public static void main(String[] args) {
		...
		System.out.print("나이을 입력하시오 : "); int age = sc.nextInt();
		System.out.print("시력을 입력하시오 : "); double vision = sc.nextDouble();
		System.out.print("취미을 입력하시오 : "); String hobby = sc.nextLine();
