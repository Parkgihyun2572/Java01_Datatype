...
String 타입은 수치 데이터가 아니기 때문에 cast연산자를 연산자X 
Wrapper클래스의 기능을 이용
...
public class C05_Casting {
	public static void main(String[] args) {
		...
		System.out.println(a);//실수(1.0)로 자동 타입 변환
		
		int num1 = 20;
		double num2 = num1; //자동으로 타입 변환되어 저장된다.
		System.out.println(num2);
		
		int ch = 'A'; //문자를 숫자로 자동 타입 변환하여 저장
		System.out.println(ch); //문자A는 아스키코드 값으로 65
		System.out.println("======");
